...
export class ProductComponent implements OnInit {
    ...
    this.http
      ...
      .subscribe(
        (res: any) => {
          ...
          if (res.rescode == 200) {
            this.http
              .post(environment.apiBaseUrl + "/products/save", formValue.value)
              .subscribe((res: any) => {
    ...
    if (this.selectedFile) {
      ...
      this.http
        ...
        .subscribe((res: any) => {
          ...
          if (res.rescode == 200) {
            this.http
              .post(environment.apiBaseUrl + "/products/edit", dataAllmEdit)
              .subscribe((res: any) => {
                if (res.rescode == 200) {
      ...
      this.ngxService.start();
      this.http
        .post(environment.apiBaseUrl + "/products/edit", this.mEdit)
        .subscribe((res: any) => {
          this.ngxService.stop();
          if (res.rescode == 200) {
            this.txtShowStatus = res.messageDetailEdit;
  ...
  onDeleteData(dataId) {
    if (confirm("Do You Want to delete?" + " " + dataId)) {
      this.ngxService.start();
      this.http
        .get(environment.apiBaseUrl + "/products/delete/" + dataId)
        .subscribe((res: any) => {
          this.ngxService.stop();
